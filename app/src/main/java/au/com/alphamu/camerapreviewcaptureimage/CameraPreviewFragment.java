...
public class CameraPreviewFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,ViewGroup container,
		...
		mButtonClick2 = (Button) v.findViewById(R.id.button_click2);
		mButtonClick3 = (Button) v.findViewById(R.id.button_click3);
		...
		mButtonClick3.setOnClickListener(v1 -> {
		...
		mButtonClick2.setOnClickListener(v1 -> {
			if (mNumberOfCameras == 1) {
				AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
				builder.setMessage(getResources().getString(R.string.camera_alert))
			...
			// parameters.
			mCamera = Camera.open((cameraCurrentlyLocked + 1) % mNumberOfCameras);
